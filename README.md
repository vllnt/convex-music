...
- `[planned]` Multiple searches per host — named profiles over one catalog, or named mounts for
  isolated instances (e.g. an artists-only search and a tracks-only search side by side).
